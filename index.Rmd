...
You can [email me](mailto:bernat.puertas@upf.edu) and you'll find me at Universitat Pompeu Fabra, Campus de la Ciutadella, Office 20.135. You can also check my [Google Scholar](https://scholar.google.es/citations?user=0jGbQHkAAAAJ&hl=es&authuser=3) profile, my [Twitter](https://twitter.com/bernat_puertas) and my [Bluesky](https://bsky.app/profile/bernatpuertas.bsky.social)

</p>

```{r me, echo=FALSE, fig.align='center', fig.dim=c(4,2), out.width = "50%"}
knitr::include_graphics("jo_cecilia.jpeg")
```
